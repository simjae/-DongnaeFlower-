...
<? }else{ ?>
		...
		<div class="orderDetail">
			...
			<div class="flowerWrap">
				<div class="flowerGroup">
					<div class="flowerInfo fn_s3_w9">꽃정보</div>
			...
			<div class="order_receiveWrap">
				<div class="order_receiveGroup" style="padding: 20px;">
					...
					<div class="receiveBtnType">
						<div class="typeBtn" id="deliveryBtn" style="margin-right: 10px;" onClick="ReceiverDetailShow('<?=$deliAbleArea?>')">입력 주소지로 배달</div>
						<div class="typeBtn" id="pickupBtn" onclick="receiveTypeSel(this,'1')">해당 꽃집에서 픽업</div>
			...
			<div id="pick_group">
				<?
					...
					$addr = $row -> com_addr;
				?>
				<div class="addr_item"style="border:none;padding:20px 20px 20px 30px; border-top:solid 1px #a0a0a0;">
			...
			<div class="pickupReceiveWrap"style="border:none;padding:20px 20px 20px 30px; border-top: 1px solid #a0a0a0; display:none;">
				...
				<div class="pickupReceiveGroup" style="padding:0">
					<div class= "receiveText fn_s3_w9">수령 시간<span style="color:#969696; font-weight:500; font-size:0.9em; margin-left:15px;" >*직접 받을 수 있는 시간을 선택해 주세요.</span></div>
					<div style="margin-top:10px;">
						<input class="input_selected input start_date" type="text" style="margin-right: 10px;background: url(/app/skin/basic/svg/timesale_product_underArrow.svg) no-repeat 96% 60%/12px;border: solid 1px #a0a0a0;text-align: center;width: 35%;border-radius: 30px;padding: 2px 7px;" size="10"  name="start_date" id="start_date">
						<SELECT name="start_hour" id="start_hour" class="select select_n fs_075" style="margin-right: 10px;width: 20%;border: 1px solid #a0a0a0;border-radius: 30px;margin-top: 5px;">
							<?
						...
						<SELECT name="start_minute" id="start_minute" class="select select_n fs_075" style="width: 20%;border: 1px solid #a0a0a0;border-radius: 30px;margin-top: 5px;">
							<?
								for($i= 0 ; $i < 6; $i ++) { 
									if($i == 0){
										$tempTime ="0".$i;
			...
			<div class="receivePriceGrop flex_sb" style="margin-top: 0px; border-top:solid 1px #a0a0a0; display:none;">
				<div>
	...
	*/
	...
	function CheckForm(gbn,temp2) {
		...
		var receiveDate = new Date(document.form1.start_date.value);
		var startH = $('#start_hour option:selected').val();
		var startM = $('#start_minute option:selected').val();
		var receiveDateTime = new Date(document.form1.start_date.value + ' ' + startH + ':' + startM);
	...
	function addAddrDetail(name,tel1,tel2,post,addr1,addr2){
		var html = "<div style =\"border-top:solid 1px #a0a0a0; padding-left:15px\">";
