...
.notiBox .notiGruop .notiImg{width: 80px; height:80px;}
.notiBox .notiGruop .notiTextWrap{margin-left:20px;}
.notiBox .notiGruop .textGroup >div{margin-bottom: 5px;}
.notiBox .notiGruop .notiCnt{font-weight:800;font-size:2.6rem;fill: #FFA000;display: flex;letter-spacing:-50px}
	...
	<div id="main_visual">
					...
					<div class="venderSwiper" style="box-sizing:border-box;overflow:hidden;">
						...
						?>
							...
							<div class="swiper-slide venderWrap">
								<div class="shopImage" style="width:80px!important;height:80px!important;border-radius:10px;background:url('/data/shopimages/vender/<?=$cont?>') no-repeat;background-size:cover"></div>
							</div>
		...
		<div class="notiBox" style="background-color: #FFEBEB;">
			<div class="notiGruop">
				...
				<div class="notiTextWrap">
					<div class="notiCnt tsCntNum" style="fill:#d2396e;">
