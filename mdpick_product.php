...
<div id="content">
	...
	<div class="mdPickList">
		...
		<?
			...
			$rcsql="SELECT a.idx, a.md_id, a.productcode, a.mdpick_banner, a.mdpick_title, a.mdpick_regdate, b.sellprice, b.sellcount FROM tblmdpick_prinfo AS a LEFT OUTER JOIN tblproduct b ON a.productcode=b.productcode WHERE a.mdpick_title != '' ";

			if($sort=="price"){
				$rcsql.="ORDER BY b.sellprice ";
			}else if($sort=="sellcount"){
				$rcsql.="ORDER BY b.sellcount DESC ";
			}else{
				$rcsql.="ORDER BY a.mdpick_regdate DESC ";
			}
			...
			$sql.="WHERE a.mdpick_title != '' AND (b.group_check='N' OR c.group_code='".$_ShopInfo->getMemgroup()."') ";
			...
			while($row=mysql_fetch_object($result)){
				...
				//MD 정보 확인
				$mdsql="SELECT * from tblmdpick WHERE md_id='".$row->md_id."' ";
