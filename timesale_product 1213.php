...
<script>
	$(document).ready(function() {
		var pointx = <?=$pointx?>;
		var pointy = <?=$pointy?>;
		var paramData = "search_flg=all&mb_addr_point_x=" + pointx + "&mb_addr_point_y=" + pointy;
	...
	function setResetBtnClickEvent() {
		$('.resetBtn').click(function() {
			...
			$('.sortDropText').attr('sort','0');
			$('.sortDropText').text('최근 등록순');
	...
	function sortDrop(){
		$('.sortDropbtn').click(function(){
			...
			console.log('call sortDropdownEvent');
		});
	}
	function sortDropdownEvent(){
		$('.sortBtn').click(function(){
			console.log('sortDropdown Click');
	...
	function changeSelectedImgEvent(category) {
		...
		if (category.hasClass('selected')) {
			if (categoryVal == "all") {
				...
				var imgNameArr = ['category_timesale.png','category_flowerpot.png','category_todayflower.png'];
				for (var i=1; i<=3; i++) {
...
.detailFilterGruop{padding: 20px 10px;}
.filterList{border-radius: 13px;font-size: 0.85em;border: 1px  solid #c8c8c8;color:#282828;font-weight: 500;text-align:center;width: 90px;}
...
<div class="selectFilterWrap">
	<div class="selectFilterGruop d_f_J">
		<div style="width:75px;height:75px;" class="filterRound categoryBtn" category="all">
			<img style="padding-top:3px;margin-left:5px;width:45px;height:45px;" src="/app/images/category/category_all_selected.gif" alt="">
		...
		<div style="width:75px;height:75px;" class="filterRound categoryBtn" category="FP">
			<img style="padding-top:3px;width:45px;height:45px;" src="/app/images/category/category_flowerpot.png" alt="">
			<div class="filterFontS">화분</div>
		</div>
		<div style="width:75px;height:75px;" class="filterRound categoryBtn" category="TF">
			<img style="padding-top:2px;width:45px;height:45px;" src="/app/images/category/category_todayflower.png" alt="">
			<div class="filterFontS" style="margin-top:-1px;">오늘의꽃</div>
		</div>
	</div>
</div>
<div class="detailFilterWrap">
	<div class="detailFilterGruop d_f_J">
		<div class="filterList resetBtn" style="display: flex; justify-content: center;width:30px;font-size: 1.0em;border-radius: 50%;">
			<img style="width: 10px;" src="/app/skin/basic/svg/spinArrow.svg" alt="">
		</div>
		<div class="filterList sortDropdown"  style="font-size: 1.0em;">
			<div class="sortDropbtn">
				<span class="sortDropText" style="margin-left: 6px;" sort="0">최근 등록순</span>
				<img class="sortArrowImg" src="/app_beta/skin/basic/svg/timesale_product_underArrow.svg" alt="">
			</div>
