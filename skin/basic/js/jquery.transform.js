	...
	***************************/
	$.fn.jqTransSelect = function(){
		return this.each(function(index){
			...
			$wrapper.prepend('<div><span></span><a href="#" class="transformSelectOpen"></a></div><ul></ul>');
			...
			$('span:first', $wrapper).click(function(){$("a.transformSelectOpen",$wrapper).trigger('click');});
			oLabel && oLabel.click(function(){$("a.transformSelectOpen",$wrapper).trigger('click');});
			this.oLabel = oLabel;

			/* Apply the click handler to the Open */
			var oLinkOpen = $('a.transformSelectOpen', $wrapper)
				.click(function(){
