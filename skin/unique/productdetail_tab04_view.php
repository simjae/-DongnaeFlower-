		...
		<section class="tab_area"> 
			<ul class="tab_type1 tab01">
				...
				<li style="position:relative;">
					<a href="productdetail_tab03.php?productcode=<?=$productcode?>&sort=<?=$sort?>#tapTop" rel="external">상품평</a>
					<div id="reviewCnt"><?=$t_cnt3?></div>
				</li>
				<li class="active" style="position:relative;">
					<a href="productdetail_tab04.php?productcode=<?=$productcode?>&sort=<?=$sort?>#tapTop" rel="external">상품문의</a>
					<div id="qnaCnt"><?=$t_cnt4?></div>
				</li>
			</ul>
		</section>
		<!-- //view탭 -->
