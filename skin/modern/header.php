...
<head>
	...
	<link href="/m/skin/modern/css/common.css" rel="stylesheet" type="text/css"/>
	<link href="/m/skin/modern/css/default.css" rel="stylesheet" type="text/css"/>
	<link href="/m/skin/modern/css/swiper.min.css" rel="stylesheet" type="text/css">
	<link href="/m/skin/modern/css/normalize.css" rel="stylesheet" type="text/css" media="all">
	<link href="/m/skin/modern/css/top.css" rel="stylesheet" type="text/css">
	<link href="/m/skin/modern/css/main.css" rel="stylesheet" type="text/css">
	<link href="/m/skin/modern/css/bottom.css" rel="stylesheet" type="text/css"> 
	<link href="/m/skin/modern/css/detail.css" rel="stylesheet" type="text/css">
	<link href="/m/skin/modern/css/list.css" rel="stylesheet" type="text/css">
	<link href="/m/skin/modern/css/login.css" rel="stylesheet" type="text/css">
	<link href="/css/jquery-ui/jquery-ui.min.css" rel="stylesheet" type="text/css" />

	<script type="text/javascript" src="/lib/lib.js.php"></script>
	<script type="text/javascript" src="/m/js/common.js"></script>
	<script type="text/javascript" src="/m/skin/modern/js/jquery-3.2.1.min.js"></script>
	<script type="text/javascript" src="/m/skin/modern/js/jquery.transform.js"></script>
	<script type="text/javascript" src="/m/skin/modern/js/swiper.min.js"></script>
	<script type="text/javascript" src="/m/skin/modern/js/common.js"></script>
		...
		<div class="wrapper">
			<div id="header">
				...
				<div id="left_menu" data-sidebar>
					...
					<div class="left_nav">
						<div class="logoMemberbg">
						<div class="logo"><? if(file_exists($logo)==true) {?><a href="./" rel="external"><img src="<?=$logo?>" alt="" /></a><? } ?></div>
							<div class="left_login">
								...
								<? }else{ //로그인 상태일 때 ?>
									<div><a href="logout.php" rel="external">로그아웃</a></div>
									<div><a href="mypage.php" rel="external">마이페이지</a></div>
								<? } ?>
...
-->
						...
						<div class="left_category">
							...
							<? }else{ ?>
								...
								<? if($nums>0 || $nums2>0){ ?>
									<? if($nums2>0){ ?><li><a href="productbest.php" rel="external"><span class="best">Best</span></a></li><? } ?>
									<? if($nums>0){ ?><li><a href="productnew.php" rel="external"><span class="new">New</span></a></li><? } ?>
								<? } ?>
	...
	<div id="mosearch" style="display:none;position:fixed;top:0px;left:0px;width:100%;height:100%;background:rgba(0,0,0,0.7);z-index:1000;">
		<div style="position:absolute;top:0px;left:0px;width:100%;text-align:right;right:1%;"><a href="#" class="close_modal" style="color: #fff;position: absolute;font-size: 34px;right: 15px;top:15px;">×</a></div>
		<div style="display:table;width:100%;height:100%;">
			<div style="display:table-cell;font-size:0px;text-align:center;vertical-align:middle;">
				...
				<input type="hidden" name="mode" value="search" />
				<input type="hidden" name="terms" value="productname" />
				<input type="text" name="prsearch" value="" placeholder="상품을 검색하세요." style="font-size:0.9rem;height:40px;width:80%;padding:0px 5px;border:0px solid rgba(255,255,255,0.5);box-sizing:border-box;color:#f9f9f9;border-bottom:1px solid #f9f9f9;" />
				<input type="button" value="" id="btn_tsearch_submit" style="height:40px;width:20px;margin-top:0px;padding:0px 10px;background:url('/m/skin/modern/img/search2.png') no-repeat;background-size:100%;background-position:center;border:none;vertical-align:top;border-bottom:1px solid #f9f9f9;" />
				</form>
			</div>
		</div>
	</div>

	<? if($main_check==1){ //메인 페이지일 때 ?>
		<div id="gotop"></div>
	<? }else{ //메인 페이지 아닐 때 ?>
		<div class="topHeight" id="gotop"></div>
	<? } ?>
		...
		$(document).ready( function(){
			$(window).scroll( function(){
				if($(document).scrollTop()>60){
					$('#top .wrapper').css('background','rgba(255,255,255,0.9)');
				}else{
					$('#top .wrapper').css('background','none');
				}
			});
		});
	</script>