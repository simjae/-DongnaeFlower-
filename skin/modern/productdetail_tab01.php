...
<script type="text/javascript">
	...
	function move_Panel(val){
		if($('.tab_move_panel').length){
			...
			$('html, body').animate({scrollTop : offset.top-60}, 50);
		}
	}
</script>
	...
	<ul class="detail_panel">
		<li id="prdetail_panel" class="panel_li">
			...
			<div class="detail_more" style="text-align:center;">
				<p style="margin-bottom:30px;text-align:center;">상세정보를 확대해서 확인하고 싶으실 경우<br />아래 [상품정보 확대보기] 버튼을 클릭해 주세요.</p>
				<div onClick="prdetailView();" style="display: inline-block;padding: 0 2em;border: 1px solid #6a6a6a;line-height: 4em;font-size: 15px;color: #848484;"><img src="/m/skin/modern/img/search.png">상품정보 확대보기</div>
			</div>
