<?
	...
	if($type=='insert'){
		$countSql="SELECT count(*) FROM tblorderreceiver WHERE member_id='".$_ShopInfo->getMemid()."' ";
		$addrCount=mysql_query($countSql,get_db_conn());
...
<style>
	...
	#btn_addr2{color: white;border-radius: 5px;background-color: #ed4380;padding: 10px 126px;font-weight: 600;}
</style>

<div id="content">
	<div class="h_area2">
		<h2 style="border-bottom:1px solid #c5c4c5;">새로운 배송지 추가</h2>
		<a href="main.php" class="btn_home" rel="external"><span class="vc">홈</span></a>
		<a href="javascript:history.back()" class="btn_prev" rel="external"><span>이전</span></a>
	</div>
	<div style="border-bottom:solid 1px #9e9e9e36">
		<div style="width:90%;margin:0 auto 0 30px;padding:25px 0px;text-align:center;">
	...
	<div style="width:100%;margin:0 auto;box-sizing:border-box;background:#fff;">
		<form name="form1" action="<?=$_SERVER[PHP_SELF]?>" method="post">
			<input type="hidden" name="type" />

			<table border="0" cellpadding="0" cellspacing="0" width="100%" style="padding:30px;" class="delivery_addr">
				<colgroup>
					<col width="25%" />
					<col width="" />
				</colgroup>
			...
			<div style="padding-top:20px;border-top:1px solid #9e9e9e36;text-align:center;">
				<div style="width: 100%;margin-left: 10%;margin-top: 20px;">
					<a href="#" onclick="CheckForm()" id="btn_addr2">완료
					</a>
				</div>
			</div>
		</form>
...
<script language="javascript">
	...
	function CheckForm(){
		...
		var strTel = document.form1.receiver_tel1.value
		if(!IsNumeric(strTel.replace(/-/gi,""))) {
