...
<form name="requestForm" id="requestForm" action="request_proc.php" method="post" enctype="multipart/form-data">
	...
	<div id="purposeForm" style="display:none;">
		...
		<tr>
			<td style="width:50%" >
				<input onclick="purposeInptClickEvent()" class="flowerPurpose" type="text" readonly placeholder="꽃 용도">
			</td>
			<td style="width:50%" >
				<input  onclick="productTypeInptClickEvent()" class="flowerProductType" type="text" readonly placeholder="꽃 종류">
	...
	<div id="priceRangeForm" style="display:none">
		<table cellpadding=0 cellspacing=0 border=0 style="width:100%;">
			<tr>
				<td>
					<input  onclick="priceRangeInptClickEvent()" class="flowerPriceRange" type="text" num="" readonly placeholder="꽃 가격">
				</td>
			</tr>
		</table>
	</div>	
		...
		<table cellpadding=0 cellspacing=0 border=0 style="width:100%;">
			...
			<div class="priceRangeWrap" style="margin: 10px;">
				<?
					$i = 2;
					$col_num = 0;
					$priceRangeTextArr = array('소소한 만족을 원해요','가성비를 추구해요','만족도가 높아요','고급스럽고 풍성해요');
						...
						<td>
							<div class="triangle-isosceles first_isosceles left">
								<span class="comment" style="display: inline;font-size:1.0rem;">
									<font class="fc_pink" style="font-weight:500">꽃집 제안</font>은<br>
									꽃집에서 꽃을 제안드리는<br>
									일대일 맞춤형 주문입니다.<br>
								</span>
							</div>
