...
?>
	...
	<div class="wrapper1">
		...
		<?
			...
			$sql.= "a.tag, a.tinyimage, a.minimage, a.maximage, a.wideimage, a.etctype, a.option_price, a.madein, a.model, a.brand, a.selfcode, a.prmsg, a.option1, a.option2, a.option_quantity, a.productdisprice, if(a.productdisprice>0,1,0) as isdiscountprice, a.youtube_url, a.youtube_prlist, a.youtube_prlist_file, a.youtube_prlist_imgtype ";
			$sql.= $addsortsql;
				...
				<div class="product_a">
					...
					<?
						...
						<li class="product_item">
							...
							<div class="product_info" <?=($productlist_quick=='Y'?"":"")?>>
