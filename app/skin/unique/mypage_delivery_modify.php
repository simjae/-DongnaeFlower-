	...
	<div style="width:90%;margin:0 auto;padding:30px 0px;box-sizing:border-box;background:#fff;">
		<form name="form2" action="<?=$_SERVER[PHP_SELF]?>" method="post">
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%" class="delivery_addr">
				...
				<tr>
					<th>수신자명</th>
					<td style="padding:5px 0px;"><input type="text" name="receiver_name" value="<?=$row->receiver_name?>" maxlength="10" class="input" style="width:44%;" /></td>
				</tr>
				<tr>
					<th>전화번호</th>
				...
				<tr>
					<th>휴대폰</th>
					<td style="padding:5px 0px;">
						<input type="tel" name="receiver_tel2" value="<?=$receiver_tel2?>" maxlength="13" class="input" style="width:100%;" />
					</td>
				</tr>
				<tr>
					<th>이메일</th>
					<td style="padding:5px 0px;"><input type="text" name="receiver_email" value="<?=$row->receiver_email?>" maxlength="40" class="input" style="width:100%;" /></td>
				</tr>
				<tr>
					<th>주소</th>
					<td style="padding:5px 0px;">
			...
			<div style="margin-top:20px;padding-top:20px;border-top:1px solid #eee;text-align:center;">
				...
				<a href="#" onclick="CheckForm('<?=$idx?>')" class="btn_s_line2">배송지 수정하기</a>
			</div>
		</form>
	</div>
</div>
