...
function executeKakaoStoryLink(post,appid,appname,title,desc,imageurl)
{
    kakao.link("story").send({   
        ...
        appver : "1.0",
        appname : appname,
        urlinfo : JSON.stringify({title:title, desc:desc, imageurl:[imageurl], type:"article"})
    });
}

function executeKakaoLink(msg,url,appid,appname)
{
    /* 
