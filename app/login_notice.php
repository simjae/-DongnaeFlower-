...
<div id="login" style="background-color:#ffe7e7;height:100%;">
	...
	<div class="popupBody" style="padding-top:5%;margin-top:-5px;">
		...
		<div class="contentWrap" style="margin-top:-5px;">
			<div class="bodyContent">
				...
				<div class="bCont fw_bold_500 fc_dgry"><플로리스트/고객> 여러분 감사합니다.</div>
				...
				<div class="bCont fw_bold_500 fc_dgry">향후 플로리스트/고객의 니즈를</div>
