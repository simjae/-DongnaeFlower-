...
require("./paygate/E_LITE_PHP/lib/NicepayLite.php");
/*
*******************************************************
* <결제요청 파라미터>
...
$nicepay->m_MerchantKey = $martkey; // 상점키
$nicepay->m_MID         = $martid;                          // 상점아이디
$nicepay->m_Moid        = $ordercode;                     // 상품주문번호
$nicepay->m_Price       = $last_price;                               // 결제상품금액
$nicepay->m_BuyerEmail  = $sender_email;                    // 구매자메일주소
$nicepay->m_BuyerName   = $sender_name;                             // 구매자명 
$nicepay->m_BuyerTel    = $sender_tel;                        // 구매자연락처           
$nicepay->m_GoodsName   = $goodname;                         // 결제상품명                     
$goodsCnt               = "1";                                  // 결제상품개수
